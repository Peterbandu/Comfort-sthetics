...
stockProductos.forEach((producto) => {
    ...
    div.innerHTML = `
    <span Style="background: #900; color:#fff; padding: 10px; border-radius: 20px; z-index: 999">Promoción</span>
    <a href="${producto.url}" style="text-decoration: none">
    <img class="img img-thumbnail" src=${producto.img} alt= "">
